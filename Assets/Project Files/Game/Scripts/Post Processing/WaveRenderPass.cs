...
{
    public class WaveRenderPass : ScriptableRenderPass
    {
        ...
        public WaveRenderPass(string profilerTag, RenderPassEvent renderPassEvent, Material materialToBlit)
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.Blit(cameraColorTargetIdent, Shader.PropertyToID(tempTexture.name), materialToBlit, 0);

            // ...then blit it back again 
            //cmd.Blit(tempTexture.Identifier(), cameraColorTargetIdent);
            cmd.Blit(Shader.PropertyToID(tempTexture.name), cameraColorTargetIdent);
